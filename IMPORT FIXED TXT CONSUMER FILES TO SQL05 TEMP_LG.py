...
merged_table_name = "test2"#"GPCONSUMER_TEST_240304_files_1_2_3" #all the files will be imported to this a table with this name
split_amount = 50000
    ...
    if str(filename[-3:]) != '.py':
      ...
      if filename.endswith("." + str(extension)) and filename.startswith('consumer_split-'):  
          ...
          with engine.connect() as conn:
            ...
            df.to_sql(merged_table_name , schema='dbo', con=engine, dtype=dtype, index=False, if_exists='append')#, chunksize=5, method='multi')
            print("imported file")
